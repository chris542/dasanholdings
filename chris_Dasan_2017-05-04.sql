...
# Generation Time: 2017-05-04 05:29:20 +0000
# ************************************************************
...
INSERT INTO `banners` (`id`, `title`, `description`, `bgImg`, `created_at`, `updated_at`)
VALUES
	(1,'Eco Friendly','All of our products are Eco-Friendly products.','toiletTissueBG.jpeg','2017-05-04 14:23:13','2017-05-04 15:24:56'),
	(2,'Fastest Delivery Service','We will deliver your products within 2 days from your purchse!','delivery.jpeg','2017-05-04 14:27:07','2017-05-04 14:27:07'),
	(3,'High Quality Products','Our products are all in high quality but cheaper price!','banner.jpg','2017-05-04 15:22:53','2017-05-04 15:27:24');
...
VALUES
	(1,'Admin','Admin','185 Waihoehoe Road Drury Auckland',211543033,272460125,'admin@dasanholdings.com',0,1,'$2y$10$BG4KoVSAlw1X2.iKxXojDuW1y7wAyTve4yIN6M4EqJ8xOUEZxEeGq','NJYMt2Px23Oc0nPo1i7VrtA1d2Ef9lhv48R3ZeM05VPhaXMGDWI9MOlhttpI','2017-05-02 12:51:33','2017-05-02 12:51:33'),
	(2,'Chris','Kang','185 Waihoehoe Road',211551340,211551340,'chris.sm.kang542@gmail.com',0,0,'$2y$10$JKhJHSUj5h3SnysPq9HUcestye1vRvjD4X3QAaWYutECAIdp.Wtn6','MPsQoZXthK7SAfTVqyaNxTWTBJiiaRzNaf2dppDaSb2HmcLYnMEpz29ggeLR','2017-05-03 16:29:15','2017-05-03 16:29:15');
